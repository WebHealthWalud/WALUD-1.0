...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Pagos
        // ✅ /payments/stats DEBE ir ANTES de /payments para que Laravel
        //    no interprete 'stats' como un {id} de /payments/{id}
        Route::get('/payments/stats',  [AdminController::class, 'paymentStats']);
        Route::get('/payments',        [AdminController::class, 'indexPayments']);

        // ✅ NUEVO: Historial clínico para administrador
        Route::get('/medical-records',       [AdminController::class, 'indexMedicalRecords']);
        Route::get('/medical-records/{id}',  [AdminController::class, 'showMedicalRecord']);
