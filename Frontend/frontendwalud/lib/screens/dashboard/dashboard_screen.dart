            ...
            Column(
              children: [
                _QuickCard(
                  ...
                  title: 'Agendar Cita',
                  subtitle:
                      'Encuentra especialistas disponibles en tu zona hoy mismo.',
                ...
                _QuickCard(
                  ...
                  title: 'Ver Historial',
                  subtitle:
                      'Accede a tus resultados, recetas y diagnósticos anteriores.',
                ...
                if (user?.isPatient == true) ...[
                  ...
                  _QuickCard(
                    ...
                    title: 'Realizar Pago',
                    subtitle:
                        'Gestiona tus facturas pendientes y métodos de pago.',
              ...
              children: [
                Expanded(
                  child: _QuickCard(
                    ...
                    title: 'Agendar Cita',
                    subtitle:
                        'Encuentra especialistas disponibles en tu zona hoy mismo para tu próxima revisión.',
                    actionLabel: 'Comenzar',
                    onTap: () => widget.onNavigate(1),
                  ),
                ),
                ...
                Expanded(
                  child: _QuickCard(
                    ...
                    title: 'Ver Historial',
                    subtitle:
                        'Accede a tus resultados, recetas y diagnósticos anteriores de forma segura.',
                    actionLabel: 'Consultar',
                    onTap: () => widget.onNavigate(2), // ✅ historial real
                  ),
                ),
                if (user?.isPatient == true) ...[
                  ...
                  Expanded(
                    child: _QuickCard(
                      ...
                      title: 'Realizar Pago',
                      subtitle:
                          'Gestiona tus facturas pendientes y métodos de pago seguros vinculados a tu cuenta.',
                      actionLabel: 'Pagar ahora',
                      onTap: () => widget.onNavigate(widget.pagosIndex),
                    ),
                  ),
...
class _NextAppointmentCard extends StatelessWidget {
  ...
  const _NextAppointmentCard({required this.appointment, this.currentUser});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${appointment.especialidad} • Clínica Walud',
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      DateFormat('d MMM', 'es').format(appointment.dateTime),
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
