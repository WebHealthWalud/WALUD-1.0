...
class _AppointmentsListScreenState extends State<AppointmentsListScreen> {
  ...
  List<Appointment> get _filtered {
    switch (_filter) {
      ...
      case 'Realizadas':
        return _all
            .where((a) => a.status == AppointmentStatus.realizada)
            .toList();
      case 'Canceladas':
        return _all
  ...
  // Abrir CreateAppointmentScreen en modo EDICIÓN
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Gestiona y consulta el historial de tus consultas médicas.',
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Cabecera con nombres de columnas claros
                  Padding(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 20,
                      vertical: 12,
                  ...
                  if (_isLoading)
                    ...
                    ..._filtered.asMap().entries.map(
                      (e) => _buildRow(e.value, e.key.isOdd),
                    ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 20),
          // Botón editar desde la card de próxima cita
      ...
      builder: (_) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            // Editar abre CreateAppointmentScreen en modo edición
            if (a.status == AppointmentStatus.pendiente &&
