...
class User {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'is_active':     isActive,
    // ✅ FIX: roles Spatie deben persistirse para que isAdmin/isDoctor
    // funcionen correctamente tras recargar la página (SharedPreferences).
    // Sin esto, al recargar el user_data guardado no tiene 'roles'
    // y el fallback de isPatient = (!isAdmin && !isDoctor) = true siempre.
    'roles':         roles,
  };
